...
MethodHeader: Type ID LPAR RPAR                     {$$=add_son(create_node("MethodHeader", NULL, line_yacc, col_yacc), add_bro($1, add_bro(create_node("Id",$2, line_yacc, col_yacc), create_node("MethodParams", NULL, line_yacc, col_yacc))));}
    | Type ID LPAR FormalParams RPAR                {$$=add_son(create_node("MethodHeader", NULL, line_yacc, col_yacc), add_bro($1, add_bro(create_node("Id",$2, line_yacc, col_yacc), add_son(create_node("MethodParams", NULL),$4, line_yacc, col_yacc))));}
